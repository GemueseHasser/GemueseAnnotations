...
@SupportedAnnotationTypes("de.jonas.jannotations.annotation.BuilderProperty")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
public final class BuildProcessor extends AbstractProcessor {

    @Override
    public boolean process(
        final Set<? extends TypeElement> set,
